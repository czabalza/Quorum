...
u25 = User.create(name: "guest", email: "guest@quorum.com", password: "password")
...
s5 = u1.subscriptions.create(tag_id: 5)
s6 = u1.subscriptions.create(tag_id: 6)
s7 = u1.subscriptions.create(tag_id: 7)
s8 = u1.subscriptions.create(tag_id: 8)
s9 = u1.subscriptions.create(tag_id: 9)
s10 = u1.subscriptions.create(tag_id: 10)
s11 = u1.subscriptions.create(tag_id: 11)
s12 = u1.subscriptions.create(tag_id: 12)
s13 = u1.subscriptions.create(tag_id: 13)
s14 = u1.subscriptions.create(tag_id: 14)
s15 = u1.subscriptions.create(tag_id: 15)
s16 = u1.subscriptions.create(tag_id: 16)
s17 = u1.subscriptions.create(tag_id: 17)
s18 = u1.subscriptions.create(tag_id: 18)
s19 = u1.subscriptions.create(tag_id: 19)
s20 = u1.subscriptions.create(tag_id: 20)
s21 = u1.subscriptions.create(tag_id: 21)
s22 = u1.subscriptions.create(tag_id: 22)
s23 = u1.subscriptions.create(tag_id: 23)
s24 = u1.subscriptions.create(tag_id: 24)
s25 = u1.subscriptions.create(tag_id: 25)
s26 = u1.subscriptions.create(tag_id: 26)
s27 = u1.subscriptions.create(tag_id: 27)
s28 = u1.subscriptions.create(tag_id: 28)
s29 = u1.subscriptions.create(tag_id: 29)
s30 = u1.subscriptions.create(tag_id: 30)
s31 = u1.subscriptions.create(tag_id: 31)
s32 = u1.subscriptions.create(tag_id: 32)
s33 = u1.subscriptions.create(tag_id: 33)
s34 = u1.subscriptions.create(tag_id: 34)
s35 = u1.subscriptions.create(tag_id: 35)
s36 = u1.subscriptions.create(tag_id: 36)
s37 = u1.subscriptions.create(tag_id: 37)
s38 = u1.subscriptions.create(tag_id: 38)
s39 = u1.subscriptions.create(tag_id: 39)
